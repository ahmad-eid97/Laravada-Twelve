    ...
    <div class="row m-0 align-items-center justify-content-center">
      <div class="col-lg-6 image">
        ...
        <img
          ...
          src="https://the7.io/business-advisors/wp-content/uploads/sites/72/elementor/thumbs/art010-pds1596pvt1x7d9kzpg7w87egfg1fpk91g26o19x5c.jpg"
          alt=""
        />
      ...
      <div class="col-lg-6 textSide" style="padding: 0 60px">
        ...
        <p>
          Wondering ipsum dolor sit amet? We consectetur adipiscing elit tempor
...
.contact .form-control {
  ...
  border: 2px solid rgb(226, 233, 239);
  border-radius: 6px;
  color: rgb(0, 0, 0);
  font-size: 18px;
  height: 59px;
